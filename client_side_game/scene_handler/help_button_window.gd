...
var help_text_dict = {
	...
	'question_generator' : 'You are now ready to start uploading your notes, on the bar below the game title choose whether you would like to upload new notes or use previous ones',
	'space_quiz' : 'Ready? You will now have to defend your spacestation, use the spaceship to shoot down incoming asteroids. In the middle of the spacestation at the bottom you can see the amount of hp your spacestation has left shown as shields. Down there you can also see a green bar with a number next to it, this displays the amount of hp your spaceship has. When you get hit you will get a question generated from your notes, answer correct to survive!',
}
