...
@onready var game_guide_pop_up = get_parent().get_parent().get_node('game_guide_pop_up')
@onready var game_guide_text_label = get_parent().get_parent().get_node('game_guide_pop_up').get_node('guide_text_panel').get_node('guide_text_label')
